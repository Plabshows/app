    ...
    const handleSave = async () => {
        ...
        try {
            ...
            if (!updatedProfile || updatedProfile.length === 0) {
                throw new Error("RLS: Error al actualizar tabla 'profiles'. Cero filas afectadas.");
            }
            ...
            console.log(error);
            console.error('[handleSave] GLOBAL ERROR:', error);
            Toast.show({ type: 'error', text1: 'Error en base de datos', text2: error.message || JSON.stringify(error) });
        } finally {
            setSaving(false);
            setIsUploading(false);
        }
